...
def inizio():
    ...
    nemicoy4 = round(random.randrange(6, infoObject.current_h - oggetto_n) / oggetto_n) * oggetto_n
    ...
    while not gioco:
        ...
        if y11 < -x12:
            ...
            x11 = random.randint(4, infoObject.current_w)
            x12 = random.randint(6, infoObject.current_h)

        if y14 < -y13:
            y14 = infoObject.current_h
            x14 = random.randint(10, infoObject.current_w)
            y13 = random.randint(0, infoObject.current_w)
